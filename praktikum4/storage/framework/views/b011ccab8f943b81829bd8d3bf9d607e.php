                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control" type="text" name="firstName" id="firstName"
                                value="<?php echo e($employee->firstname); ?>" placeholder="Enter First Name">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="lastName" class="form-label">Last
                                Name</label>
                            <input class="form-control" type="text" name="lastName" id="lastName"
                                value="<?php echo e($employee->lastname); ?>" placeholder="Enter Last Name">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="email" class="form-label">Email</label>
                            <input class="form-control" type="text" name="email" id="email"
                                value="<?php echo e($employee->email); ?>" placeholder="Enter Email">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="age" class="form-label">Age</label>
                            <input class="form-control" type="text" name="age" id="age"
                                value="<?php echo e($employee->age); ?>" placeholder="Enter Age">
                        </div>
...
<?php /**PATH E:\semester 6\Pemrograman Framework\project laravel\praktikum4\resources\views/employee/edit.blade.php ENDPATH**/ ?>